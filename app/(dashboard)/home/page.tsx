...
export default function DashboardPage() {
  ...
  // const registrationOverviewData = farmerRegistrationData.map(
  //   (item, index) => ({
  //     month: item.month,
  //     Farmers: item.count,
  ...
  const insuranceCard = [
    {
      ...
      description:
        "Comprehensive protection for your cattle and livestock. Safeguard your farm's most valuable assets with our specialized coverage.",
    ...
    },
    {
      ...
      description:
        "Complete health coverage for you and your family. Access quality healthcare with our comprehensive medical insurance plans.",
      buttonText: "Apply Now",
      bgColor: "DFF8FF",
      category: "health",
    },
    {
      ...
      description:
        "Secure your family's future with our life insurance policies. Ensure financial protection for your loved ones.",
      buttonText: "Apply Now",
      bgColor: "F2EEFE",
      category: "life",
    },
  ...
  //   //                 <CardDescription>
  //   //                   Comparison of farmer and cattle registrations over time
  //   //                 </CardDescription>
  //   //               </CardHeader>
  ...
  //   //                 <CardDescription>
  //   //                   Monthly health status of cattle
  //   //                 </CardDescription>
  //   //               </CardHeader>
  //   //               <CardContent className="pl-2">
  //   //                 <ChartContainer
  ...
  //   //                 <Select
  //   //                   value={selectedCow}
  //   //                   onValueChange={(value) => setSelectedCow(value as CowKey)}
  //   //                 >
  ...
  //   //                 </div>
  //   //                 <CardDescription>
  //   //                   Number of new farmers registered over time
  //   //                 </CardDescription>
  //   //               </CardHeader>
  //   //               <CardContent className="pl-2">
  //   //                 <ChartContainer
  ...
  //   //                 </div>
  //   //                 <CardDescription>
  //   //                   Number of new cattle registered over time
  //   //                 </CardDescription>
  //   //               </CardHeader>
  //   //               <CardContent className="pl-2">
  //   //                 <ChartContainer
  ...
  //   //               <CardDescription>
  //   //                 Monthly comparison between farmer and cattle registrations
  //   //               </CardDescription>
  //   //             </CardHeader>
  //   //             <CardContent className="pl-2">
  //   //               <ChartContainer
  ...
  //   //                   <CardDescription>
  //   //                     Weight progression for selected cow
  //   //                   </CardDescription>
  //   //                 </div>
  //   //                 <Select
  //   //                   value={selectedCow}
  ...
  //   //                 <CardDescription>
  //   //                   Percentage of healthy vs. sick cattle over time
  //   //                 </CardDescription>
  //   //               </CardHeader>
  //   //               <CardContent className="pl-2">
  //   //                 <ChartContainer
  ...
  //   //               <CardDescription>
  //   //                 Weight comparison between different cattle
  //   //               </CardDescription>
  //   //             </CardHeader>
  //   //             <CardContent className="pl-2">
  //   //               <ChartContainer
