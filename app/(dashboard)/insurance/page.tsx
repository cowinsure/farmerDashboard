        ...
        <>
            <div className="  text-gray-600">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <Link href={'insurance/activePolicy'} className="bg-[#E5EBE7] shadow-md rounded-lg p-4 hover:bg-[#228C45] hover:text-white transition-colors duration-300">
                    ...
                    <div className="bg-[#E5EBE7] shadow-md rounded-lg p-4 hover:bg-[#228C45] hover:text-white transition-colors duration-300">
