...
function LargeSidebar() {
  ...
  return (
    <div
      className={`h-screen flex flex-col items-center justify-center transition-width duration-300 ${
    ...
    >
      <div className="h-12 mb-5 flex flex-row items-center justify-around w-full">
        ...
        <button
          ...
          className="bg-green-800 cursor-pointer text-white p-1 rounded-xl"
        >
          {isOpen ? (
            <FaChevronRight
              size={14}
              className="rotate-180 transition-all duration-75"
            />
          ) : (
      ...
      <div className="h-full w-full text-black flex flex-col justify-start items-start">
        <Link
          href="/home"
          onClick={() => {
            setIsActiveMenu("Home");
          }}
          className={`p-4   w-full hover:bg-green-800 hover:text-white flex items-center ${
            isActiveMenu == "Home" ? "bg-green-800 text-white " : ""
          }`}
        >
        ...
        <Link
          ...
          className={`p-4   w-full hover:bg-green-800 hover:text-white flex items-center ${
            isActiveMenu == "Me" ? "bg-green-800 text-white " : ""
          }`}
        >
        ...
        <Link
          href="/farmer"
          onClick={() => {
            setIsActiveMenu("Farm");
          }}
          className={`p-4   w-full hover:bg-green-800 hover:text-white flex items-center ${
            isActiveMenu == "Farm" ? "bg-green-800 text-white" : ""
          }`}
        >
        ...
        <Link
          href="/insurance"
          onClick={() => {
            setIsActiveMenu("Insurance");
          }}
          className={`p-4   w-full hover:bg-green-800 hover:text-white flex items-center ${
            isActiveMenu == "Insurance" ? "bg-green-800 text-white" : ""
          }`}
        >
